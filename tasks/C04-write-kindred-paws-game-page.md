...
**Done 2026-09-13:** copy, genre, platforms, engine and jam taken from the studio's itch.io page. Status stays "In development": itch.io says "Released", but that build is only a demo. The share image stays the studio card, and the header art stays the 315×250 menu shot, until F06 delivers art.
