...
|---|---|---|---|---|---|---|
| F01 | [Replace the stock hero photo with real Bearer art](F01-replace-stock-hero-with-bearer-art.md) | Fix | P1 | S | Blocked | — |
| F02 | [Point "Meet the team" at the team section](F02-fix-meet-the-team-link.md) | Fix | P1 | XS | Todo | — |
| F03 | [Move the footer into a real `<footer>` and show the current year](F03-move-footer-into-footer-element-with-current-year.md) | Fix | P2 | S | Todo | — |
| F04 | [Link the Instagram and Bluesky profiles in the footer](F04-link-social-profiles-in-footer.md) | Fix | P2 | XS | Blocked | F03 |
| F05 | [Replace the "COMING SOON" Bearer card art with a text-free image](F05-use-text-free-bearer-card-art.md) | Fix | P1 | XS | Blocked | — |
...
| F08 | [Add Open Graph / Twitter tags, canonical, a descriptive title and a `<noscript>` fallback](F08-add-social-meta-canonical-and-noscript.md) | Fix | P1 | S | Todo | — |
| F09 | [Add visible focus styles and a skip link](F09-add-focus-styles-and-skip-link.md) | Fix | P1 | S | Todo | — |
| F10 | [Respect `prefers-reduced-motion`](F10-respect-prefers-reduced-motion.md) | Fix | P2 | XS | Todo | — |
| F11 | [Raise the minimum text size to 12 px](F11-raise-minimum-text-size.md) | Fix | P2 | S | Todo | — |
...
| F14 | [Add a usable mobile navigation](F14-add-mobile-navigation-menu.md) | Fix | P1 | M | Todo | F09 |
| F15 | [Add a branded 404 page that works under `/pjteam/`](F15-add-404-page.md) | Fix | P3 | S | Todo | — |
| F16 | [Add sitemap.xml and robots.txt](F16-add-robots-and-sitemap.md) | Fix | P3 | XS | Todo | F08 |
